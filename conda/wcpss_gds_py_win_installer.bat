...
call conda env create -f https://github.com/wcpss-geo/wcpss_gds_py_env/raw/conda/gds_py.yml
REM Activate environment
call conda activate wcpss_gds
REM Add pip packages
call conda install -y -c conda-forge git
pip install --user -r https://github.com/wcpss-geo/wcpss_gds_py_env/raw/conda/gds_py_pip.txt
